...
import { Gamepad2, Clock, ArrowRight, Blocks, LayoutList } from 'lucide-react';
...
const GamePreviewCard = ({ game, onPlay }) => {
  const gameInfo =
          ...
          >
            ...
            <div className="relative flex flex-col items-center text-center h-full justify-center gap-6">
              ...
              <div>
                ...
                <p className="text-md text-white/90">{gameInfo.previewText}</p>
              </div>
              ...
              {game.game_type === 'drag-drop' && (
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    {game.rounds[0].choices.slice(0, 3).map((choice, index) => (
                      <span
                        key={index}
